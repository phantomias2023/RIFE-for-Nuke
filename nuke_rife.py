import logging
import torch
from model.IFNetv4 import IFNet

logging.basicConfig(level=logging.INFO)
LOGGER = logging.getLogger(__name__)
PATH = "model/flownet_v25.pkl"
TORCHSCRIPT_MODEL = "./nuke/RIFE_4.pt"
...
class FlowNetNuke(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        scale_list = (16.0 / scale, 8.0 / scale, 4.0 / scale, 2.0 / scale, 1.0 / scale)
